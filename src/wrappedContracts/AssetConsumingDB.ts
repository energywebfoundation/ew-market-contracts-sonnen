    ...
    export class AssetConsumingDB extends GeneralFunctions
{
    ...
    constructor(web3: Web3, address?: string){
        super(address ? new web3.eth.Contract(AssetConsumingDBJSON.abi, address) : new web3.eth.Contract(AssetConsumingDBJSON.abi, AssetConsumingDBJSON.networks.length > 0 ? (AssetConsumingDBJSON.networks[0]) : null))
        this.web3 = web3
    }
