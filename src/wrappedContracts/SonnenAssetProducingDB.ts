    ...
    import SonnenAssetProducingDBJSON from '../../contract-build/SonnenAssetProducingDB.json'

    export class SonnenAssetProducingDB extends GeneralFunctions
{
    web3: Web3
    buildFile = SonnenAssetProducingDBJSON
    constructor(web3: Web3, address?: string){
        super(address ? new web3.eth.Contract(SonnenAssetProducingDBJSON.abi, address) : new web3.eth.Contract(SonnenAssetProducingDBJSON.abi, SonnenAssetProducingDBJSON.networks.length > 0 ? (SonnenAssetProducingDBJSON.networks[0]) : null))
        this.web3 = web3
    }
	...
	async getMarketProperties(_assetId:number, txParams?:SpecialTx){
		return (await this.web3Contract.methods.getMarketProperties(_assetId).call(txParams)) 
	}
	...
	async getSonnenAssetById(_assetId:number, txParams?:SpecialTx){
		return (await this.web3Contract.methods.getSonnenAssetById(_assetId).call(txParams)) 
	}
	...
	async addFullSonnenAsset(_a:any, txParams?:SpecialTx){

            let transactionParams

            const txData = await this.web3Contract.methods.addFullSonnenAsset(_a)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.addFullSonnenAsset(_a)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.addFullSonnenAsset(_a)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
	...
	async getSonnenAssetBySmartMeter(_smartMeter:string, txParams?:SpecialTx){
		return (await this.web3Contract.methods.getSonnenAssetBySmartMeter(_smartMeter).call(txParams)) 
	}
	...
	async setMarketProperties(_assetId:number,_marketProps:any, txParams?:SpecialTx){

            let transactionParams

            const txData = await this.web3Contract.methods.setMarketProperties(_assetId,_marketProps)
            .encodeABI()
            ...
            if(txParams){
                ...
                if(!txParams.gas){
                    ...
                    try{
                    gas = await this.web3Contract.methods.setMarketProperties(_assetId,_marketProps)
                        .estimateGas({ from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]} )
                    } catch(ex){
            ...
            if (transactionParams.privateKey !== '') {
                ...
                return await this.web3Contract.methods.setMarketProperties(_assetId,_marketProps)
                    .send({from: transactionParams.from, gas: transactionParams.gas}) 
            }
	}
